        ...
        if (args.length == 0) {
            ...
            if (cmd.equalsIgnoreCase("reload")) {
                ...
                for (Module m : ClearLag.getModules()) {
                    ...
                    switch (m) {
                        case EventModule eventModule -> events.append(s);
                        case CommandModule commandModule -> commands.append(s);
                        case TaskModule taskModule -> tasks.append(s);
                        default -> modules.append(s);
                    }
                }
