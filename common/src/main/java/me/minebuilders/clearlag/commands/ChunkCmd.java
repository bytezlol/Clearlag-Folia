...
public class ChunkCmd extends CommandModule {
    ...
    protected void run(CommandSender sender, String[] args) {
        final AtomicInteger size = new AtomicInteger((args.length >= 1 && Util.isInteger(args[0])) ? Integer.parseInt(args[0]) : 5);
        final Integer[] sizes = new Integer[size.get()];
        final Chunk[] chunks = new Chunk[size.get()];
