...
**Extras**
- Language files are extracted to `plugins/ClearLag/languages/` on first run, so they can be edited directly via the server panel. Changes take effect on `/lagg reload` without a restart.
